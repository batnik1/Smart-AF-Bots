...
def make_sorting_area():
   ...
   # pygame.draw.rect(screen,colors.BLUE,pygame.Rect(racks_width,80,sorting_w,sorting_h),3)
    pygame.draw.line(screen, colors.BLUE, (racks_width+10, 90), (racks_width-40, 90), width=2)
    pygame.draw.line(screen, colors.BLUE, (racks_width+10, 150), (racks_width-40, 150), width=2)
    pygame.draw.line(screen, colors.BLUE, (racks_width+10, 240), (racks_width-40, 240), width=2)
